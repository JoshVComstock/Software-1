...
{ 
  ...
  const enviar=async (e)=> {
    ...
    const response=await fetch('http://127.0.0.1:8000/api/informativo',{
      method:'POST',
      headers:{
  ...
  async function llenarinformativos()
  {
    const response=await fetch('http://127.0.0.1:8000/api/informativo',{
      method:'GET',
      headers:{
  ...
  setFoto(resultado);
    ...
    return(
      ...
      <Divcontainer className="container-portada">
         ...
         <Divbox>
         <Divgrupo>                                                                      
              <H1titulo className="titulo-portada">Informativos Pesquisas</H1titulo>
